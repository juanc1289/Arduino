...
float theta,error2,V,V1,Int_E,Area,Der_E,lastE,alpha,error1;
const float dt=0.001024; /*sample time*/
const float kp=36.0;
const float ki=0.0710;
const float kd=0.01775;
const float kpa=15.0;
...
ISR(TIMER2_OVF_vect)
{
  ...
  constrain(Int_E,-255.0,255.0);
  constrain(Der_E,-255.0,255.0);
